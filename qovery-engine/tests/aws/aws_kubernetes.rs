...
pub const QOVERY_ENGINE_REPOSITORY_URL: &str = "https://gitlab.com/qovery/qovery-engine.git";
pub const TMP_DESTINATION_GIT: &str = "/tmp/qovery-engine-master/";
pub const GIT_LOGIN: &str = "qovery-engine";
pub const GIT_TOKEN: &str = "mZDzMw55pozjvzexwQxN";
