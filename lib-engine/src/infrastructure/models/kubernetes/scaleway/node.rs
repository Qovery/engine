...
impl InstanceType for ScwInstancesType {
    fn to_cloud_provider_format(&self) -> String {
        match self {
            ScwInstancesType::BASIC2_A16C_32G => "basic2-a16c-32g",
            ScwInstancesType::BASIC2_A16C_64G => "basic2-a16c-64g",
            ScwInstancesType::BASIC2_A2C_4G => "basic2-a2c-4g",
            ScwInstancesType::BASIC2_A2C_8G => "basic2-a2c-8g",
            ScwInstancesType::BASIC2_A4C_16G => "basic2-a4c-16g",
            ...
            ScwInstancesType::H100_SXM_2_80G => "h100-sxm-2-80g",
            ...
            ScwInstancesType::POP2_48C_192G => "pop2-48c-192g",
            ...
            ScwInstancesType::POP2_HC_48C_96G => "pop2-hc-48c-96g",
    ...
    fn is_instance_allowed(&self) -> bool {
        matches!(
            self,
            ScwInstancesType::BASIC2_A16C_32G
                | ScwInstancesType::BASIC2_A16C_64G
                | ScwInstancesType::BASIC2_A2C_4G
                | ScwInstancesType::BASIC2_A2C_8G
                | ScwInstancesType::BASIC2_A4C_16G
                ...
                | ScwInstancesType::POP2_48C_192G
                ...
                | ScwInstancesType::POP2_HC_48C_96G
...
impl fmt::Display for ScwInstancesType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ScwInstancesType::BASIC2_A16C_32G => write!(f, "basic2-a16c-32g"),
            ScwInstancesType::BASIC2_A16C_64G => write!(f, "basic2-a16c-64g"),
            ScwInstancesType::BASIC2_A2C_4G => write!(f, "basic2-a2c-4g"),
            ScwInstancesType::BASIC2_A2C_8G => write!(f, "basic2-a2c-8g"),
            ScwInstancesType::BASIC2_A4C_16G => write!(f, "basic2-a4c-16g"),
            ...
            ScwInstancesType::H100_SXM_2_80G => write!(f, "h100-sxm-2-80g"),
            ...
            ScwInstancesType::POP2_48C_192G => write!(f, "pop2-48c-192g"),
            ...
            ScwInstancesType::POP2_HC_48C_96G => write!(f, "pop2-hc-48c-96g"),
...
impl FromStr for ScwInstancesType {
    ...
    fn from_str(s: &str) -> Result<ScwInstancesType, CommandError> {
        match s {
            "basic2-a16c-32g" => Ok(ScwInstancesType::BASIC2_A16C_32G),
            "basic2-a16c-64g" => Ok(ScwInstancesType::BASIC2_A16C_64G),
            "basic2-a2c-4g" => Ok(ScwInstancesType::BASIC2_A2C_4G),
            "basic2-a2c-8g" => Ok(ScwInstancesType::BASIC2_A2C_8G),
            "basic2-a4c-16g" => Ok(ScwInstancesType::BASIC2_A4C_16G),
            ...
            "h100-sxm-2-80g" => Ok(ScwInstancesType::H100_SXM_2_80G),
            ...
            "pop2-48c-192g" => Ok(ScwInstancesType::POP2_48C_192G),
            ...
            "pop2-hc-48c-96g" => Ok(ScwInstancesType::POP2_HC_48C_96G),
...
mod tests {
    ...
    fn test_scaleway_to_cloud_provider_format() {
        for instance_type in ScwInstancesType::iter() {
            ...
            assert_eq!(
                match instance_type { ScwInstancesType::BASIC2_A16C_32G =>
                "basic2-a16c-32g", ScwInstancesType::BASIC2_A16C_64G =>
                "basic2-a16c-64g", ScwInstancesType::BASIC2_A2C_4G => "basic2-a2c-4g",
                ScwInstancesType::BASIC2_A2C_8G => "basic2-a2c-8g",
                ScwInstancesType::BASIC2_A4C_16G => "basic2-a4c-16g",
                ScwInstancesType::BASIC2_A4C_8G => "basic2-a4c-8g",
                ScwInstancesType::BASIC2_A8C_16G => "basic2-a8c-16g",
                ...
                ScwInstancesType::COPARM1_4C_16G => "coparm1-4c-16g",
                ScwInstancesType::COPARM1_8C_32G => "coparm1-8c-32g",
                ScwInstancesType::DEV1_L => "dev1-l", ScwInstancesType::DEV1_M =>
                "dev1-m", ScwInstancesType::DEV1_S => "dev1-s", ScwInstancesType::DEV1_XL
                => "dev1-xl", ScwInstancesType::GP1_L => "gp1-l", ScwInstancesType::GP1_M
                => "gp1-m", ScwInstancesType::GP1_S => "gp1-s", ScwInstancesType::GP1_XL
                => "gp1-xl", ScwInstancesType::GP1_XS => "gp1-xs",
                ScwInstancesType::H100_1_80G => "h100-1-80g", ScwInstancesType::H100_1_M
                => "h100-1-m", ScwInstancesType::H100_SXM_2_80G => "h100-sxm-2-80g",
                ScwInstancesType::L4_1_24G => "l4-1-24g", ScwInstancesType::L4_2_24G =>
                ...
                ScwInstancesType::POP2_HM_4C_32G => "pop2-hm-4c-32g",
                ScwInstancesType::POP2_HM_8C_64G => "pop2-hm-8c-64g",
                ScwInstancesType::POP2_HN_10 => "pop2-hn-10", ScwInstancesType::POP2_HN_3
                => "pop2-hn-3", ScwInstancesType::POP2_HN_5 => "pop2-hn-5",
    ...
    fn test_groups_nodes() {
        assert!(
            NodeGroups::new("".to_string(), 2, 1, "dev1-l".to_string(), 20, None, None,
            CpuArchitecture::AMD64, None).is_err()
        );
        assert!(
            NodeGroups::new("".to_string(), 2, 2, "dev1-l".to_string(), 20, None, None,
            CpuArchitecture::AMD64, None).is_ok()
        );
        assert!(
            NodeGroups::new("".to_string(), 2, 3, "dev1-l".to_string(), 20, None, None,
            CpuArchitecture::AMD64, None).is_ok()
        );
        assert_eq!(
            NodeGroups::new("".to_string(), 2, 2, "dev1-l".to_string(), 20, None, None,
            CpuArchitecture::AMD64, None).unwrap(), NodeGroups { name : "".to_string(),
            id : None, min_nodes : 2, max_nodes : 2, instance_type : "dev1-l"
