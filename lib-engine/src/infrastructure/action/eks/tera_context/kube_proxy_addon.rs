    ...
    pub fn new_from_k8s_version(k8s_version: KubernetesVersion) -> Self {
        AwsKubeProxyAddon {
            ...
            version: match k8s_version {
                ...
                KubernetesVersion::V1_35 { .. } => "v1.35.3-eksbuild.5",
            }
            .to_string(),
        }
    }
    ...
    fn aws_addon_kube_proxy_new_test() {
        ...
        let tests_cases = vec![
            ...
            TestCase {
                ...
                expected: AwsKubeProxyAddon {
                    version: "v1.32.6-eksbuild.2".to_string(),
                },
            },
            TestCase {
                ...
                expected: AwsKubeProxyAddon {
                    version: "v1.33.0-eksbuild.2".to_string(),
                },
            },
            TestCase {
                ...
                expected: AwsKubeProxyAddon {
                    version: "v1.34.5-eksbuild.2".to_string(),
                },
            },
            TestCase {
                ...
                expected: AwsKubeProxyAddon {
                    version: "v1.35.3-eksbuild.5".to_string(),
                },
            },
        ];
