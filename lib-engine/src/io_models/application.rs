...
impl ApplicationAdvancedSettings {
    pub fn to_container_advanced_settings(&self) -> ContainerAdvancedSettings {
        ContainerAdvancedSettings {
            ...
            network_gateway_api_cors_allow_methods: self.network_gateway_api_cors_allow_methods.clone(),
            network_gateway_api_cors_allow_headers: self.network_gateway_api_cors_allow_headers.clone(),
            network_gateway_api_whitelist_source_range: self.network_gateway_api_whitelist_source_range.clone(),
            network_gateway_api_denylist_source_range: self.network_gateway_api_denylist_source_range.clone(),
            network_gateway_api_basic_auth_env_var: self.network_gateway_api_basic_auth_env_var.clone(),
            network_gateway_api_route_limit_rpm: self.network_gateway_api_route_limit_rpm,
            ...
            network_gateway_api_circuit_breaker_max_connections: self
                .network_gateway_api_circuit_breaker_max_connections,
            network_gateway_api_circuit_breaker_max_pending_requests: self
                .network_gateway_api_circuit_breaker_max_pending_requests,
            network_gateway_api_circuit_breaker_max_parallel_requests: self
                .network_gateway_api_circuit_breaker_max_parallel_requests,
            network_gateway_api_tcp_keepalive_idle_time_seconds: self
        ...
        match cloud_provider.kind() {
            CPKind::Aws => {
                ...
                Ok(Box::new(models::application::Application::<AWS>::new(
                    ...
                    self.cpu_limit_in_milli.map(KubernetesCpuResourceUnit::MilliCpu),
