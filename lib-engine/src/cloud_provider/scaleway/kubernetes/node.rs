...
impl fmt::Display for ScwInstancesType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            ScwInstancesType::STARDUST1_S => write!(f, "stardust1-s"),
            ...
            ScwInstancesType::START1_XS => write!(f, "start1-xs"),
