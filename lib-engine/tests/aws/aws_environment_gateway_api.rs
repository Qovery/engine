...
#[named]
#[test]
fn deploy_application_with_cors_enabled_on_aws_eks() {
    engine_run_test(|| {
...
#[named]
#[test]
fn deploy_application_with_sticky_session_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_ip_whitelist_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_ip_denylist_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_both_whitelist_and_denylist_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_basic_auth_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_rate_limit_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_custom_headers_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_sticky_session_enabled_on_aws_eks_grpc() {
...
#[named]
#[test]
fn deploy_application_with_ip_whitelist_enabled_on_aws_eks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_application_with_ip_denylist_enabled_on_aws_eks_grp() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_application_with_both_whitelist_and_denylist_on_aws_eks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_application_with_basic_auth_enabled_on_aws_eks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_application_with_rate_limit_enabled_on_aws_eks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_application_with_custom_headers_enabled_on_aws_eks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_container_with_cors_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_sticky_session_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_ip_whitelist_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_ip_denylist_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_both_whitelist_and_denylist_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_basic_auth_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_rate_limit_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_custom_headers_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_sticky_session_enabled_on_aws_eks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_container_with_ip_whitelist_enabled_on_aws_eks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_container_with_ip_denylist_enabled_on_aws_eks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_container_with_both_whitelist_and_denylist_on_aws_eks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_container_with_basic_auth_enabled_on_aws_eks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_container_with_rate_limit_enabled_on_aws_eks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_container_with_custom_headers_enabled_on_aws_eks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_application_with_force_ssl_redirect_on_aws_eks_http() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_force_ssl_redirect_on_aws_eks_http() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_cors_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_sticky_session_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_ip_whitelist_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_ip_denylist_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_both_whitelist_and_denylist_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_basic_auth_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_rate_limit_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_custom_headers_enabled_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_sticky_session_enabled_on_aws_eks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_helm_with_ip_whitelist_enabled_on_aws_eks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_helm_with_ip_denylist_enabled_on_aws_eks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_helm_with_both_whitelist_and_denylist_on_aws_eks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_helm_with_basic_auth_enabled_on_aws_eks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_helm_with_rate_limit_enabled_on_aws_eks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_helm_with_custom_headers_enabled_on_aws_eks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_application_with_timeout_settings_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_router_with_multiple_domains_splits_into_multiple_routes_on_aws_eks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
        ...
        // Each domain generates 2 http_hosts entries in the Rust model (port-prefixed + bare domain),
        // and each entry then generates 2 K8s hostnames (original + new-gateway-api variant).
        // Default domain also generates 2 entries, so total = 1*2 + 10*2 = 22 http_hosts entries.
        // With max 8 http_hosts per HTTPRoute (= 16 K8s hostnames), ceil(22/8) = 3 HTTPRoute parts.
        ...
        let main_routes: Vec<_> = router_routes
            .iter()
            .filter(|route| !route.name_any().contains("-ssl-redirect"))
            .collect();
        ...
        // Verify hostnames are distributed correctly
        for route in &router_routes {
            if let Some(spec) = route.data.get("spec")
