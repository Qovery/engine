...
use qovery_engine::environment::models::azure::Credentials;
...
use qovery_engine::infrastructure::models::kubernetes::azure::{AksOptions, AzureStorageType};
...
pub const AZURE_KUBERNETES_VERSION: KubernetesVersion = KubernetesVersion::V1_35 {
    prefix: None,
    patch: None,
    suffix: None,
};
