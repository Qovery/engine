...
#[named]
#[test]
fn deploy_application_with_source_ip_sticky_session_enabled_on_scw_kapsule() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_header_sticky_session_enabled_on_scw_kapsule() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_header_sticky_session_enabled_on_scw_kapsule() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_source_ip_sticky_session_enabled_on_scw_kapsule() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_header_sticky_session_enabled_on_scw_kapsule() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_source_ip_sticky_session_enabled_on_scw_kapsule() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
