...
#[named]
#[test]
fn deploy_application_with_source_ip_sticky_session_enabled_on_gcp_gke() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_header_sticky_session_enabled_on_gcp_gke() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_header_sticky_session_enabled_on_gcp_gke() {
    let source_registry = QoverySourceRegistry::from(&Kind::Gcp);
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_source_ip_sticky_session_enabled_on_gcp_gke() {
    let source_registry = QoverySourceRegistry::from(&Kind::Gcp);
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_header_sticky_session_enabled_on_gcp_gke() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_source_ip_sticky_session_enabled_on_gcp_gke() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_timeout_settings_on_gcp_gke() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
