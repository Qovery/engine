...
pub struct FuncTestsSecrets {
    ...
    pub SCALEWAY_SECRET_TOKEN: Option<String>,
...
impl FuncTestsSecrets {
    ...
    fn get_all_secrets() -> FuncTestsSecrets {
        ...
        FuncTestsSecrets {
            ...
            SCALEWAY_SECRET_TOKEN: Self::select_secret("SCALEWAY_SECRET_TOKEN", secrets.SCALEWAY_SECRET_TOKEN),
