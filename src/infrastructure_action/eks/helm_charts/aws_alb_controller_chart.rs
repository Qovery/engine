use crate::cloud_provider::helm_charts::{HelmChartResourcesConstraintType, HelmChartVpaType};
...
mod tests {
    use crate::cloud_provider::helm_charts::{
        ...
        HelmChartResourcesConstraintType, HelmChartType, HelmChartVpaType, ToCommonHelmChart,
    };
