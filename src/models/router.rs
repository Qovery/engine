...
use crate::cloud_provider::service::{
    default_tera_context, delete_stateless_service, Action, Create, Delete, Helm, Pause, Service, ServiceType,
};
...
pub trait RouterService: Service + Create + Pause + Delete + Listen + Helm {
