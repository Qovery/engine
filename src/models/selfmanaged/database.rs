...
/////////////////////////////////////////////////////////////////
// CONTAINER
impl DatabaseType<OnPremise, Container> for PostgresSQL {
...
impl DatabaseType<OnPremise, Container> for MySQL {
    type DatabaseOptions = DatabaseOptions;
...
impl DatabaseType<OnPremise, Container> for Redis {
    type DatabaseOptions = DatabaseOptions;
...
impl DatabaseType<OnPremise, Container> for MongoDB {
    type DatabaseOptions = DatabaseOptions;
...
////////////////////////////////////////////////////////////////////////:
// POSTGRES SQL
impl ToTeraContext for Database<OnPremise, Container, PostgresSQL>
where
    PostgresSQL: DatabaseType<OnPremise, Container>,
{
...
////////////////////////////////////////////////////////////////////////:
// MySQL
impl ToTeraContext for Database<OnPremise, Container, MySQL>
where
    MySQL: DatabaseType<OnPremise, Container>,
{
    fn to_tera_context(&self, target: &DeploymentTarget) -> Result<TeraContext, Box<EngineError>> {
        self.to_tera_context_for_container(target, &self.options)
    }
...
////////////////////////////////////////////////////////////////////////:
// MongoDB
impl ToTeraContext for Database<OnPremise, Container, MongoDB>
where
    MongoDB: DatabaseType<OnPremise, Container>,
{
    fn to_tera_context(&self, target: &DeploymentTarget) -> Result<TeraContext, Box<EngineError>> {
        self.to_tera_context_for_container(target, &self.options)
    }
...
////////////////////////////////////////////////////////////////////////:
// Redis
impl ToTeraContext for Database<OnPremise, Container, Redis>
where
    Redis: DatabaseType<OnPremise, Container>,
{
    fn to_tera_context(&self, target: &DeploymentTarget) -> Result<TeraContext, Box<EngineError>> {
        self.to_tera_context_for_container(target, &self.options)
    }
