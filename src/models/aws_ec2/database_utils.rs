...
mod tests {
    ...
    #[test]
    fn test_aws_ec2_is_allowed_managed_mysql_versions() {
        // v5
    ...
    #[test]
    fn test_aws_ec2_is_allowed_managed_mysql_unsupported_versions() {
    ...
    #[test]
    fn test_aws_ec2_is_allowed_managed_redis_versions() {
        // v5
    ...
    #[test]
    fn test_aws_ec2_is_allowed_managed_redis_unsupported_versions() {
        // unsupported versions
        // <- unsupported versions to be added here
        assert_eq!(
    ...
    #[test]
    fn test_aws_ec2_is_allowed_managed_mongodb_versions() {
        // v4
    ...
    #[test]
    fn test_aws_ec2_is_allowed_managed_mongodb_unsupported_versions() {
        // unsupported versions
        // <- unsupported versions to be added here
        assert_eq!(
    ...
    #[test]
    fn test_aws_ec2_is_allowed_managed_postgres_versions() {
        // v11
    ...
    #[test]
    fn test_aws_ec2_is_allowed_managed_postgres_unsupported_versions() {
        // unsupported versions
        // <- unsupported versions to be added here
        assert_eq!(
