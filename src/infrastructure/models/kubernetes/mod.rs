...
impl KubernetesVersion {
    pub fn prefix(&self) -> &Option<Arc<str>> {
        match &self {
            ...
            KubernetesVersion::V1_35 { prefix, .. } => prefix,
        }
    }
    ...
    pub fn patch(&self) -> &Option<u8> {
        match &self {
            ...
            KubernetesVersion::V1_35 { patch, .. } => patch,
        }
    }
    ...
    pub fn suffix(&self) -> &Option<Arc<str>> {
        match &self {
            ...
            KubernetesVersion::V1_35 { suffix, .. } => suffix,
        }
    }
    ...
    pub fn previous_version(&self) -> Option<Self> {
        match self {
            ...
            KubernetesVersion::V1_35 { .. } => Some(KubernetesVersion::V1_34 {
                prefix: None,
                patch: None,
                suffix: None,
            }),
    ...
    pub fn next_version(&self) -> Option<Self> {
        match self {
            ...
            KubernetesVersion::V1_34 { .. } => Some(KubernetesVersion::V1_35 {
                prefix: None,
                patch: None,
                suffix: None,
            }),
            KubernetesVersion::V1_35 { .. } => None,
        }
    }
...
impl FromStr for KubernetesVersion {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "1.35" => Ok(KubernetesVersion::V1_35 {
                prefix: None,
                patch: None,
                suffix: None,
            }),
        ...
        for k8s_version_str in K8sVersion::iter().map(|v| v.to_string()) {
            assert_eq!(
                match k8s_version_str.as_str() {
                    ...
                    "1.35" => Ok(kubernetes::KubernetesVersion::V1_35 {
                        prefix: None,
                        patch: None,
                        suffix: None,
                    }),
        ...
        for k8s_version in K8sVersion::iter() {
            assert_eq!(
                match k8s_version {
                    ...
                    K8sVersion::V1_35 { .. } => Some(K8sVersion::V1_34 {
                        prefix: None,
                        patch: None,
                        suffix: None
                    }),
        ...
        for k8s_version in K8sVersion::iter() {
            assert_eq!(
                match k8s_version {
                    ...
                    K8sVersion::V1_34 { .. } => Some(K8sVersion::V1_35 {
                        prefix: None,
                        patch: None,
                        suffix: None
                    }),
