    ...
    pub fn new_from_k8s_version(k8s_version: KubernetesVersion) -> Self {
        AwsEbsCsiAddon {
            ...
            version: match k8s_version {
                ...
                KubernetesVersion::V1_35 { .. } => "v1.59.0-eksbuild.1",
            }
            .to_string(),
        }
    }
    ...
    fn aws_addon_ebs_csi_new_test() {
        ...
        let tests_cases = vec![
            ...
            TestCase {
                ...
                expected: AwsEbsCsiAddon {
                    version: "v1.36.0-eksbuild.1".to_string(),
                },
            },
            TestCase {
            ...
            TestCase {
                ...
                expected: AwsEbsCsiAddon {
                    version: "v1.56.0-eksbuild.1".to_string(),
                },
            },
            TestCase {
                ...
                expected: AwsEbsCsiAddon {
                    version: "v1.59.0-eksbuild.1".to_string(),
                },
            },
        ];
