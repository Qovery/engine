...
use crate::io_models::models::{KubernetesClusterAction, NodeGroups, NodeGroupsWithDesiredState};
...
pub async fn delete_eks_nodegroups(
    ...
    let nodegroups_to_delete = match nodegroup_delete_selection {
...
mod tests {
    use super::*;
    use crate::io_models::models::{CpuArchitecture, KubernetesClusterAction, NodeGroups, NodeGroupsWithDesiredState};
    use aws_sdk_eks::operation::describe_nodegroup::DescribeNodegroupOutput;
