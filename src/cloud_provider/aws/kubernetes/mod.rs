...
impl Kubernetes for EKS {
    ...
    fn on_create_error(&self) -> Result<(), EngineError> {
        ...
        send_progress_on_long_task(self, Action::Create, || create_error(self))
    }
    ...
    fn upgrade_with_status(&self, kubernetes_upgrade_status: KubernetesUpgradeStatus) -> Result<(), EngineError> {
        ...
        let mut context = tera_context(self, &self.zones, &self.nodes_groups, &self.options)?;
    ...
    fn on_upgrade_error(&self) -> Result<(), EngineError> {
        ...
        send_progress_on_long_task(self, Action::Create, || upgrade_error(self))
    }
    ...
    fn on_downgrade_error(&self) -> Result<(), EngineError> {
        ...
        send_progress_on_long_task(self, Action::Create, || downgrade_error(self))
    }
    ...
    fn on_pause_error(&self) -> Result<(), EngineError> {
        ...
        send_progress_on_long_task(self, Action::Pause, || pause_error(self))
    }
    ...
    fn on_delete_error(&self) -> Result<(), EngineError> {
        ...
        send_progress_on_long_task(self, Action::Delete, || delete_error(self))
    }
...
impl Kubernetes for EC2 {
    ...
    fn on_pause(&self) -> Result<(), EngineError> {
        ...
        send_progress_on_long_task(self, Action::Pause, || {
            pause(self, self.template_directory.as_str(), &self.zones, &vec![], &self.options)
        })
    }
    ...
    fn on_delete(&self) -> Result<(), EngineError> {
        ...
        send_progress_on_long_task(self, Action::Delete, || {
            delete(self, self.template_directory.as_str(), &self.zones, &vec![], &self.options)
        })
    }
