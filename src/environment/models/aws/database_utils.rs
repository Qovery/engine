...
pub(crate) fn is_allowed_managed_mysql_version(requested_version: &VersionsNumber) -> Result<(), DatabaseError> {
...
pub(crate) fn is_allowed_managed_mongodb_version(requested_version: &VersionsNumber) -> Result<(), DatabaseError> {
...
pub(crate) fn is_allowed_managed_postgres_version(requested_version: &VersionsNumber) -> Result<(), DatabaseError> {
...
pub(crate) fn is_allowed_managed_redis_version(requested_version: &VersionsNumber) -> Result<(), DatabaseError> {
...
#[cfg(test)]
mod tests {
    use crate::environment::models::aws::database_utils::{
    ...
    fn test_aws_is_allowed_managed_postgres_versions() {
        ...
        // v17
        assert!(is_allowed_managed_postgres_version(&VersionsNumberBuilder::new().major(17).build()).is_ok());
        assert!(is_allowed_managed_postgres_version(&VersionsNumberBuilder::new().major(17).minor(11).build()).is_ok());
        assert!(is_allowed_managed_postgres_version(
