...
impl From<errors::Tag> for Tag {
    fn from(tag: errors::Tag) -> Self {
        match tag {
            ...
            errors::Tag::TerraformCommandTimeout => Tag::TerraformCommandTimeout,
            ...
            errors::Tag::PlatformPreflightFailed => Tag::PlatformPreflightFailed,
            ...
            errors::Tag::K8sSetDefaultStorageClassError => Tag::K8sSetDefaultStorageClassError,
            errors::Tag::K8sCannotDeletePDB => Tag::K8sCannotDeletePDB,
            errors::Tag::K8sCannotGetPDBs => Tag::K8sCannotGetPDBs,
            ...
            errors::Tag::CannotRefreshKarpenterControllerAmi => Tag::CannotRefreshKarpenterControllerAmi,
