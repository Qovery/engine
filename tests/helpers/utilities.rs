...
pub struct FuncTestsSecrets {
    ...
    pub AWS_DEFAULT_TEST_DOMAIN: Option<String>,
    pub AZURE_TEST_ORGANIZATION_ID: Option<String>,
    pub AZURE_TEST_ORGANIZATION_LONG_ID: Option<Uuid>,
    pub AZURE_TEST_CLUSTER_ID: Option<String>,
    pub AZURE_TEST_CLUSTER_LONG_ID: Option<Uuid>,
    ...
    pub AZURE_DEFAULT_REGION: Option<String>,
    pub AZURE_DEFAULT_TEST_DOMAIN: Option<String>,
    ...
    pub GCP_DEFAULT_TEST_DOMAIN: Option<String>,
    ...
    pub SCALEWAY_DEFAULT_TEST_DOMAIN: Option<String>,
...
impl FuncTestsSecrets {
    ...
    fn get_all_secrets() -> FuncTestsSecrets {
        FuncTestsSecrets {
            ...
            AWS_DEFAULT_TEST_DOMAIN: Self::parse_secret("AWS_DEFAULT_TEST_DOMAIN"),
            AZURE_DEFAULT_TEST_DOMAIN: Self::parse_secret("AZURE_DEFAULT_TEST_DOMAIN"),
            GCP_DEFAULT_TEST_DOMAIN: Self::parse_secret("GCP_DEFAULT_TEST_DOMAIN"),
            SCALEWAY_DEFAULT_TEST_DOMAIN: Self::parse_secret("SCALEWAY_DEFAULT_TEST_DOMAIN"),
            ...
            DOCKER_HUB_USERNAME: Self::parse_secret("DOCKER_HUB_USERNAME"),
            DOCKER_HUB_TOKEN: Self::parse_secret("DOCKER_HUB_TOKEN"),
    ...
    match db_kind {
        ...
        DatabaseKind::Postgresql => {
            ...
            DBInfos {
                db_port: database_port,
                db_name: database_db_name.to_string(),
                app_commit: "eb83eb61319f27f4f85a52b24f92466a75d6daac".to_string(),
                app_env_vars: btreemap! {
