use crate::helpers;
use crate::helpers::azure::azure_infra_config;
...
#[named]
#[test]
fn deploy_application_with_cors_enabled_on_azure_aks() {
    engine_run_test(|| {
...
#[named]
#[test]
fn deploy_application_with_sticky_session_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_source_ip_sticky_session_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_header_sticky_session_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_ip_whitelist_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_ip_denylist_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_both_whitelist_and_denylist_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_basic_auth_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_rate_limit_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_custom_headers_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_sticky_session_enabled_on_azure_aks_grpc() {
...
#[named]
#[test]
fn deploy_application_with_ip_whitelist_enabled_on_azure_aks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_application_with_ip_denylist_enabled_on_azure_aks_grp() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_application_with_both_whitelist_and_denylist_on_azure_aks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_application_with_basic_auth_enabled_on_azure_aks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_application_with_rate_limit_enabled_on_azure_aks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_application_with_custom_headers_enabled_on_azure_aks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_container_with_cors_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_sticky_session_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_header_sticky_session_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_source_ip_sticky_session_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_ip_whitelist_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_ip_denylist_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_both_whitelist_and_denylist_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_basic_auth_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_rate_limit_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_custom_headers_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_sticky_session_enabled_on_azure_aks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_container_with_ip_whitelist_enabled_on_azure_aks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_container_with_ip_denylist_enabled_on_azure_aks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_container_with_both_whitelist_and_denylist_on_azure_aks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_container_with_basic_auth_enabled_on_azure_aks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_container_with_rate_limit_enabled_on_azure_aks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_container_with_custom_headers_enabled_on_azure_aks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_application_with_force_ssl_redirect_on_azure_aks_http() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_force_ssl_redirect_on_azure_aks_http() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_cors_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_sticky_session_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_header_sticky_session_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_source_ip_sticky_session_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_ip_whitelist_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_ip_denylist_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_both_whitelist_and_denylist_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_basic_auth_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_rate_limit_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_custom_headers_enabled_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_sticky_session_enabled_on_azure_aks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_helm_with_ip_whitelist_enabled_on_azure_aks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_helm_with_ip_denylist_enabled_on_azure_aks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_helm_with_both_whitelist_and_denylist_on_azure_aks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_helm_with_basic_auth_enabled_on_azure_aks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_helm_with_rate_limit_enabled_on_azure_aks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_helm_with_custom_headers_enabled_on_azure_aks_grpc() {
    use qovery_engine::io_models::application::Protocol::GRPC;
...
#[named]
#[test]
fn deploy_application_with_custom_http_errors_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_custom_http_errors_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_custom_http_errors_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_circuit_breaker_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_container_with_circuit_breaker_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_helm_with_circuit_breaker_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_application_with_timeout_settings_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
...
#[named]
#[test]
fn deploy_router_with_multiple_domains_splits_into_multiple_routes_on_azure_aks() {
    engine_run_test(|| {
        let span = span!(Level::INFO, "test", name = function_name!());
        let _enter = span.enter();
