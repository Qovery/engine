## Release notes engine v1.275.0   
### Features   
* [7f01077fb2f3e420c4d8b8ae0c627a52a0206c49](https://github.com/Qovery/engine/commit/7f01077fb2f3e420c4d8b8ae0c627a52a0206c49): feat(blueprint): Support helm deployment  (Antoine Promerova)
   
### Bug fixes   
* [c55b578371ff5955cb7081d5460b33fb8c7add2f](https://github.com/Qovery/engine/commit/c55b578371ff5955cb7081d5460b33fb8c7add2f): fix(GKE): Fix missing credentials  (Antoine)
   
### Others   
* [0f8bc6c32fc58557743e0b036204bc3daeba1ee9](https://github.com/Qovery/engine/commit/0f8bc6c32fc58557743e0b036204bc3daeba1ee9): feat(QOV-1620): add Kubernetes 1.35 version support  (Guillaume Dubroeucq)
## Release notes engine v1.274.1   
### Others   
* [b54dd5ec23ddf4ae1159b0afe504f8d2eaeca5f8](https://github.com/Qovery/engine/commit/b54dd5ec23ddf4ae1159b0afe504f8d2eaeca5f8): fix(q-job): unblock Karpenter consolidation and pin cronjobs to dedicated nodepool  (Guillaume Da Silva)
## Release notes engine v1.274.0   
### Others   
* [b54dd5ec23ddf4ae1159b0afe504f8d2eaeca5f8](https://github.com/Qovery/engine/commit/b54dd5ec23ddf4ae1159b0afe504f8d2eaeca5f8): fix(q-job): unblock Karpenter consolidation and pin cronjobs to dedicated nodepool  (Guillaume Da Silva)
## Release notes engine v1.273.0   
### Others   
* [d53a2a6c0cb96d04f1d4f1493801e46b83942749](https://github.com/Qovery/engine/commit/d53a2a6c0cb96d04f1d4f1493801e46b83942749): feat(k8s-event-logger): Apply the same RBAC when prometheus is not enabled  (Σrebe - Romain GERARD)
## Release notes engine v1.272.2   
### Bug fixes   
* [2aecdfee80ba4103004afadc6a1ad38826b95ffb](https://github.com/Qovery/engine/commit/2aecdfee80ba4103004afadc6a1ad38826b95ffb): fix(obs): disable duplicate kubelet resource metrics scrape on GCP and SCW  (Pierre Gerbelot)
## Release notes engine v1.272.1   
### Bug fixes   
* [88d8f6ae48b1701edf347b97a0c2ae2faf8ca667](https://github.com/Qovery/engine/commit/88d8f6ae48b1701edf347b97a0c2ae2faf8ca667): fix(secrets): Use correct role arn variable  (Antoine)
   
### Others   
* [2f2894c106710e352cc425503892a46727e1332e](https://github.com/Qovery/engine/commit/2f2894c106710e352cc425503892a46727e1332e): chore(agents) add AGENTS.md  (benjaminch)
## Release notes engine v1.272.0   
### Features   
* [a419bbf4e1fe1e229b85df202964ab1dd9a01c7d](https://github.com/Qovery/engine/commit/a419bbf4e1fe1e229b85df202964ab1dd9a01c7d): feat(blueprint): Add terraform deployment  (Antoine Promerova)
   
### Others   
* [0b50b842e0b1be78ff9c17e1214222523dd3a8d2](https://github.com/Qovery/engine/commit/0b50b842e0b1be78ff9c17e1214222523dd3a8d2): feat(QOV-1664): grant cluster-agent and shell-agent list access on apps workloads  (Fabien FLEUREAU)
## Release notes engine v1.271.1   
### Internal changes   
* [1db7fdd161d9834c5ec50e27c83913177e52bca3](https://github.com/Qovery/engine/commit/1db7fdd161d9834c5ec50e27c83913177e52bca3): chore(karpenter): increase nodepool grace period  (Σrebe - Romain GERARD)
## Release notes engine v1.271.0   
### Others   
* [73787b7a5be62b6488a5c56ec16af73d820ca0a3](https://github.com/Qovery/engine/commit/73787b7a5be62b6488a5c56ec16af73d820ca0a3): feat(QOV-1895): Gateway-API: deprecated field `message: spec.targetRef is...  (Pierre Gerbelot)
## Release notes engine v1.270.1   
### Others   
* [297e15d9960f6e692a6fab97bacf9baf47a53c6b](https://github.com/Qovery/engine/commit/297e15d9960f6e692a6fab97bacf9baf47a53c6b): chore(QOV-1884): gateway-api fix basic auth  (benjaminch)
## Release notes engine v1.270.0   
### Features   
* [fb0e6316f2f0b69dac965bd69e96823548e0f08b](https://github.com/Qovery/engine/commit/fb0e6316f2f0b69dac965bd69e96823548e0f08b): feat(blueprint): Add manifest parsing  (Antoine Promerova)
   
### Bug fixes   
* [f147fb1c08dbd991139b08ac4dcbef3e66465512](https://github.com/Qovery/engine/commit/f147fb1c08dbd991139b08ac4dcbef3e66465512): fix: add ecr-public:GetAuthorizationToken to KarpenterNodeRole  (Guillaume Da Silva)
   
* [e18e04a0384dc4242b3874e404594af83d64b5bf](https://github.com/Qovery/engine/commit/e18e04a0384dc4242b3874e404594af83d64b5bf): fix: application deploy helm error swallowed  (benjaminch)
   
### Others   
* [906696d732d8e6373898464940402754e62bf754](https://github.com/Qovery/engine/commit/906696d732d8e6373898464940402754e62bf754): feat(QOV-1874): add retry advanced settings with service/cluster fallback  (Pierre Gerbelot)
## Release notes engine v1.264.2   
### Others   
* [3c9db9244dcd6813fde1d135b2b1637c17568c74](https://github.com/Qovery/engine/commit/3c9db9244dcd6813fde1d135b2b1637c17568c74): fix(external-dns): prefix checksum annotation with 0x to prevent YAML numeric coercion  (Fabien FLEUREAU)
## Release notes engine v1.269.0   
### Others   
* [243e8556539a4b7b771196a537f439e059796af0](https://github.com/Qovery/engine/commit/243e8556539a4b7b771196a537f439e059796af0): feat(qov-1882) Clean orphan kube secrets at service deletion  (Melvin Zottola)
## Release notes engine v1.268.0   
### Features   
* [b89db7e723b5428be8372573cb4f1e4a669fb253](https://github.com/Qovery/engine/commit/b89db7e723b5428be8372573cb4f1e4a669fb253): feat(blueprint): Add request and task  (Antoine Promerova)
   
### Internal changes   
* [74875afe42dd81cb958e4693c0f146152b9dced2](https://github.com/Qovery/engine/commit/74875afe42dd81cb958e4693c0f146152b9dced2): chore(ai): Add claude.md  (Antoine Promerova)
   
### Others   
* [37879f80b57266dd885adecd7fc8f24a3921bf16](https://github.com/Qovery/engine/commit/37879f80b57266dd885adecd7fc8f24a3921bf16): fix(external-dns): prefix checksum annotation with 0x to prevent YAML numeric coercion  (Fabien FLEUREAU)
   
* [76f741d932c62d24259ded80928db6f42f02bfa5](https://github.com/Qovery/engine/commit/76f741d932c62d24259ded80928db6f42f02bfa5): fix(qov-1564) Enable qovery role to assume auto eso role  (Melvin Zottola)
## Release notes engine v1.267.0   
### Features   
* [ce19e7e817bd1be231984d85933bf98c148229fa](https://github.com/Qovery/engine/commit/ce19e7e817bd1be231984d85933bf98c148229fa): feat(eksa):  split vsphere.rs into focused sub-modules and wire KEDA parameters  (Pierre Gerbelot)
   
* [4a5756ade19628fff28384d8e95f9af5f4ee64de](https://github.com/Qovery/engine/commit/4a5756ade19628fff28384d8e95f9af5f4ee64de): feat(eksanywhere): harden EKS-A upgrade backup and preflight flow  (Pierre Gerbelot)
## Release notes engine v1.264.1   
### Others   
* [9ed63d302f366a15362193b9d990674439ef5efb](https://github.com/Qovery/engine/commit/9ed63d302f366a15362193b9d990674439ef5efb): chore(external-dns): remove aws-zone-type flag for route53  (Σrebe - Romain GERARD)
## Release notes engine v1.266.0   
### Others   
* [c7a3bc8c30b48fba3d63dd9157930b04aa713de1](https://github.com/Qovery/engine/commit/c7a3bc8c30b48fba3d63dd9157930b04aa713de1): feat(qov-1868) Enable external secrets on helm arguments  (Melvin Zottola)
## Release notes engine v1.265.0   
### Internal changes   
* [379c2d573ea142d782bc4fb2695d3b7ef0294ad6](https://github.com/Qovery/engine/commit/379c2d573ea142d782bc4fb2695d3b7ef0294ad6): chore: move commun services types to common module  (benjaminch)
   
### Others   
* [321a2bde34fcabc026937085b0ba1bf35dffd5f9](https://github.com/Qovery/engine/commit/321a2bde34fcabc026937085b0ba1bf35dffd5f9): chore(QOV-1862): add integration tests  (benjaminch)
   
* [f99e7befbafaaa3dbe0426e688cf0f9f57f8b529](https://github.com/Qovery/engine/commit/f99e7befbafaaa3dbe0426e688cf0f9f57f8b529): chore(QOV-1862): improve params parsing  (benjaminch)
   
* [5ac11fd718ccc6a361de4f582886382bae933b5e](https://github.com/Qovery/engine/commit/5ac11fd718ccc6a361de4f582886382bae933b5e): chore(QOV-1862): update sticky session to support al types  (benjaminch)
   
* [474e0f03ec5bcd3803ba5ebb44a5872667465654](https://github.com/Qovery/engine/commit/474e0f03ec5bcd3803ba5ebb44a5872667465654): feat(gateway-api): add network.gateway_api.sticky_session_header  (Gabriel Cornesse)
## Release notes engine v1.264.1   
### Others   
* [9ed63d302f366a15362193b9d990674439ef5efb](https://github.com/Qovery/engine/commit/9ed63d302f366a15362193b9d990674439ef5efb): chore(external-dns): remove aws-zone-type flag for route53  (Σrebe - Romain GERARD)
## Release notes engine v1.264.0   
### Others   
* [4bbf1b1a0def853376123fc1d32a3bc8efa172bc](https://github.com/Qovery/engine/commit/4bbf1b1a0def853376123fc1d32a3bc8efa172bc): feat(qov-1569) Handle properly external secrets new values and rollback  (Melvin Zottola)
## Release notes engine v1.263.0   
### Features   
* [cb136914e4cb353020f12a61f77ce1866933a905](https://github.com/Qovery/engine/commit/cb136914e4cb353020f12a61f77ce1866933a905): feat(eksanywhere): add bounded upgrade timeouts and remove --no-timeouts  (Pierre Gerbelot)
   
### Others   
* [908d15a483d38e5609ffa8cbfb3de1f06da932de](https://github.com/Qovery/engine/commit/908d15a483d38e5609ffa8cbfb3de1f06da932de): chore(QOV-1866): Pin CI tests to on-demand NVMe nodes and bump ephemeral storage  (Guillaume Dubroeucq)
   
* [80efdbea65762ee310c26e4733bc9bc87abbe61f](https://github.com/Qovery/engine/commit/80efdbea65762ee310c26e4733bc9bc87abbe61f): chore(QOV-1866): buildx jobs to on_demand and nvme node  (Guillaume Dubroeucq)
## Release notes engine v1.262.0   
### Features   
* [fddf68494df4ebc635dbaa080506b80c310b3154](https://github.com/Qovery/engine/commit/fddf68494df4ebc635dbaa080506b80c310b3154): feat(envoy): Support user provided certificate  (Σrebe - Romain GERARD)
   
### Internal changes   
* [2c911a85fbaf89942130975d690b898dc99baaf6](https://github.com/Qovery/engine/commit/2c911a85fbaf89942130975d690b898dc99baaf6): chore(docker): Symlink plugings to temp config  (Antoine)
## Release notes engine v1.261.3   
### Internal changes   
* [bcb120e7d1656199a4bdd6ca59eb6372a5046d38](https://github.com/Qovery/engine/commit/bcb120e7d1656199a4bdd6ca59eb6372a5046d38): chore(envoy): Remove un-necessary referenceGrant and sectionName  (Σrebe - Romain GERARD)
## Release notes engine v1.261.2   
### Bug fixes   
* [e41c16129d9153b81bc86b714e03b440b52436bd](https://github.com/Qovery/engine/commit/e41c16129d9153b81bc86b714e03b440b52436bd): fix: Exclude layer 4 ports from certificate requests  (Melvin Zottola)
## Release notes engine v1.261.1   
### Internal changes   
* [a3615d08807b7ff44bcff8049514a6f027cc3c42](https://github.com/Qovery/engine/commit/a3615d08807b7ff44bcff8049514a6f027cc3c42): chore: Apply SSE-C reco for aws s3 vpc flow logs  (Melvin Zottola)
## Release notes engine v1.261.0   
### Others   
* [26c0e2134e437c4610dca5e9860a13707fbc5ee4](https://github.com/Qovery/engine/commit/26c0e2134e437c4610dca5e9860a13707fbc5ee4): feat(QOV-379): upgrade Loki helm chart to 6.55.0 (Loki 3.7.1) with simplescalable mode  (Guillaume Dubroeucq)
## Release notes engine v1.260.0   
### Others   
* [831097b1f1039df5e9c719acad9c0e34f6455693](https://github.com/Qovery/engine/commit/831097b1f1039df5e9c719acad9c0e34f6455693): feat(QOV-1835): Envoy allow to set  for cluster level allowlist  (benjaminch)
## Release notes engine v1.259.0   
### Features   
* [0880529cfa921935e759b0c06a3711912a704753](https://github.com/Qovery/engine/commit/0880529cfa921935e759b0c06a3711912a704753): feat(aws): Allow to customize load-balancer scheme  (Σrebe - Romain GERARD)
   
### Internal changes   
* [693bd9afd3706b4957a1f104799dbe0cdd7132b0](https://github.com/Qovery/engine/commit/693bd9afd3706b4957a1f104799dbe0cdd7132b0): chore(aws): disable extended support RDS database in tests  (Σrebe - Romain GERARD)
